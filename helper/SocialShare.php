  ...
  public function __invoke(ItemRepresentation $item)
  {
    ...
    return '
        ...
        <ul id="social-share" class="list-inline mb-0 mt-2 fs-4">
          ...
          <li class="list-inline-item">
            <a class="fit-green" target="_blank" href="mailto:?body=' . $body . '&subject=' . $subject . '" aria-label="Share this item via email" title="Share this item via email">
          ...
          <li class="list-inline-item">
            <a class="fit-green" target="_blank" href="https://www.facebook.com/share.php?u=' . $url . '" aria-label="Share this item on Facebook" title="Share this item on Facebook">
          ...
          <li class="list-inline-item">
            <a class="fit-green" target="_blank" href="https://x.com/intent/post?url=' . $url . '" aria-label="Share this item on X" title="Share this item on X">
